						...
						<ul class="row">
								...
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/lit1.jpg" alt="">
											</span>
										</div>
									...
									<div class="view-contact">
										<a href="Patient_Table_Agent.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/serv1.jpg" alt="">
											</span>
										</div>
										<div class="contact-name">
									...
									<div class="view-contact">
										<a href="Admission_Table_Agent.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									...
									<div class="view-contact">
										<a href="Nee_Table_Agent.php">Détails</a>
									</div>
								</div>
							</li>
