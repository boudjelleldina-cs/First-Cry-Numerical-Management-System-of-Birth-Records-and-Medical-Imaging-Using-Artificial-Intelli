            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="stat-card p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM patient ");
                ...
                <div class="col-md-3">
                    <div class="stat-card2 p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM patient WHERE med_p IS NOT NULL");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
		...
		>
           ...
           <div class="p-12 md:p-8" style="padding:0;">
				<div style="background:#0f4c81;color:white;padding:12px 15px;font-weight:700;font-size:1.2rem;
									...
									Liste des patients
									<a href="Patient_Table.php" style="background:#D42424;color:white;font-weight:700;
        ...
        <tr>
			...
			<td>
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
					...
					<a class="dropdown-item" href="patient_bon.php?id=<?php echo $row['id_patient']; ?>"><i class="fa fa-print"></i> Imprimer Bon</a>
					<a class="dropdown-item" href="#"><i class="dw dw-edit2"></i> Modifier</a>
					<a class="dropdown-item" href="patient_rapport_details.php?id=<?php echo $row['id_patient']; ?>"><i class="fa fa-book"></i> Historique</a>
					<?php 
						if ($row['med_p']=="")
						{
							echo "<a class=\"dropdown-item\" href=\"Patient_Medecin.php?id=". $row['id_patient']."\"><i class=\"fa fa-user-md\"></i>Medecin</a>"; 
						} else
						{
							...
							echo "<a class=\"dropdown-item\" href=\"patient_rapport_ajou.php?id=". $row['id_patient']."\"><i class=\"fa fa-pencil-square-o\"></i>Rapport</a>"; 
