...
if (isset($_POST["submit"])) {
		...
		$poste         = $_POST["poste"];
		$quart_travail = $_POST["quart_travail"];
	...
	if (isset($_FILES['file'])) {
			...
			$insert = "INSERT INTO `infirmier`(`nom`, `prenom`, `sexe`, `date_naissance`, `date_recrutement`, `service`, `quart_travail`, `adresse`, `telephone`, `email`, `photo`, `pass_inf`) VALUES 
			('$nom','$prenom','$sexe','$date_naissance', '$date_recrutement','$service','$quart_travail','$adresse','$telephone','$email', '{$image_base64}','$pass')";
...
">
    ...
    ">
        ...
        <h2 style="
            ...
            color:#0f172a;
        ">
            Inscription d'un(e) nouvel(le) infirmier(e)
        </h2>
    </div>
</div>
...
<div class="row">
		...
		>
           <div class="p-6 md:p-8" style="padding:0;">
				<div style="
							...
							">
				Identification de l'Infirmier(e)
				</div>
             ...
             <div class="form-group">
				...
				<input type="text" id="nom" name="nom" class="form-control" placeholder="Entrer le Nom de l'infirmier(e)">
				
				<div style="background:#e9ecef; color:black;padding:8px 12px;font-weight:600;margin-bottom:6px;border-radius:6px;">   
				Prénom   
				</div>
				<input type="text" id="prenom" name="prenom" class="form-control" placeholder="Entrer le Prénom de l'infirmier(e)">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="custom-select2 form-control" id="quart_travail" name="quart_travail" style="width: 100%; height: 38px;">
    ...
    <!-- BOTTOM RIGHT: Compte utilisateur -->
	<div class="col-md-6 mb-3">
        <div style="
					border:1px solid #ccc; 
					border-radius:10px; 
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" id="pass" name="pass" class="form-control" placeholder="Entrez le mot de passe">
                    </div>
                </div>
            </div>
