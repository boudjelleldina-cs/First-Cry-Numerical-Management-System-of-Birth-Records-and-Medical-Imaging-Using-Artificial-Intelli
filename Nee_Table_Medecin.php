		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon fas fa-user-nurse"></span><span class="mtext">Infirmière</span>
						</a>
						<ul class="submenu">
							<li><a href="index.html">Inscription</a></li>
							<li><a href="index2.html">Dossier</a></li>
        ...
        <tr>
			...
			<td>
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list" style="background-color: #D0F2C7;">
					...
					<a class="dropdown-item" href="PDF_Nee.php?id=<?php echo $row['id']; ?>"><i class="fa fa-print"></i> Pdf rapport ne(e)</a>
