...
if (isset($_POST["submit"])) {
	...
	if (isset($_FILES['file'])) {
			...
			$insert = "INSERT INTO `medecin`(`nom_med`, `prenom_med`, `sexe_med`, `date_nais_med`, `wilaya_nais_med`, `nom_med_ar`, `prenom_med_ar`, `specialite_med`, `grade_med`, `service_med`, `img_med`, `adress_med`, `adress_lieu_med`, `mail_med`, `tel_med`, `pass_med`) VALUES 
			('$nom_p','$prenom_p','$sexe','$datedenaissance','$wilaya','$nom_p_ar','$prenom_p_ar','$spec','$grade','$service', '{$image_base64}', '$adresse','$wilaya_resid','$num_tel','$mail','$pass')";
             ...
             <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div class="custom-control custom-radio mb-5">
					<input type="radio" id="sexe1" name="sexe" class="custom-control-input" value="Masculin">
					<label class="custom-control-label" for="sexe1">Masculin</label> 
				</div>
				<div class="custom-control custom-radio mb-5">
					<input type="radio" id="sexe2" name="sexe" class="custom-control-input" value="Féminin">
					<label class="custom-control-label" for="sexe2">Femenin</label>
				</div>
                       ...
                       <div class="form-group">
                        ...
                        <select class="custom-select2 form-control" id ="specialite" name="specialite" style="width: 100%; height: 38px;">
								...
								<?php
									...
									$result = mysqli_query($link, "SELECT DISTINCT Specialite FROM medecin_specialiste");
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select2 form-control" id ="grade_med" name="grade_med" style="width: 100%; height: 38px;">
								...
								<?php
									...
									$result = mysqli_query($link, "SELECT DISTINCT Grade FROM medecin_grade");
...
<div style="display:flex; justify-content:flex-end; width:100%; gap:10px; margin-top:15px;">
	...
	-->
	<button type="button" class="btn btn-danger" onclick="window.location.href='Medecin_Table.php';">Retour</button>
	<input
        type= "submit"
		id="submit"
        name = "submit"
