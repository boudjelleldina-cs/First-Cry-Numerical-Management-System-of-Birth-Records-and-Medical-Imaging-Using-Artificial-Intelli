...
<body>
	...
	<div class="main-container" style="max-width:1400px; width:100%; margin:0 auto;">
	<div class="row">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="stat-card p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM lit");
                ...
                <div class="col-md-3">
                    <div class="stat-card2 p-2">
                        ...
                        <h5 class="mb-1 text-success">Disponible</h5>
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM lit WHERE statut='disponible'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
                ...
                <div class="col-md-3">
                    <div class="stat-card3 p-2">
                        ...
                        <h5 class="mb-1 text-warning">occupe</h5>
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM lit WHERE statut='occupe'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
                ...
                <!-- Orders Card -->
                <div class="col-md-3">
                   <div class="stat-card4 p-2">
                   <div class="d-flex justify-content-between align-items-center mb-3">
                   <div class="stat-icon bg-danger bg-opacity-10">
                    <i class="fas fa-bed text-danger fs-4"></i>
                </div>
            </div>
                        <h5 class="mb-1 text-danger">Endommagé</h5>
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM lit WHERE statut='endommage'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
						...
						<div class="col-12 mb-3">
							<div style="border:1px solid #ccc;border-radius:10px;padding:16px;background:#f9f9f9;
								...
								<div style="background:#2D30ED;color:white;padding:12px 15px;font-weight:700;font-size:1.2rem;
									...
									<a href="Lit_ajout.php" style="background:white;color:#0f4c81;font-weight:700;
										padding:5px 14px;border-radius:6px;text-decoration:none;font-size:0.9rem;">
										<i class="fa fa-plus"></i> Lit
									</a>
								</div>
									...
									<table id="myTable" class="table table-striped table-hover w-100">
										<thead>
											<tr>
                                                ...
                                                <th><div class="custom-label-box">Numéro lit</div></th>
                                                <th><div class="custom-label-box">Service</div></th>
                                                <th><div class="custom-label-box">Type lit</div></th>
                                                <th><div class="custom-label-box">Statut</div></th>
                                                <th><div class="custom-label-box">Action</div></th>
											</tr>
										</thead>
										<tbody>
										<?php
										
										$res = mysqli_query($link, "SELECT * FROM lit");
										while ($row = mysqli_fetch_assoc($res)) {
										?>
										<tr>
                                            <td><?php echo $row['id']; ?></td>
<td><?php echo $row['chambre_id']; ?></td>
<td><?php echo $row['numero_lit']; ?></td>
<td><?php echo $row['Service']; ?></td>
<td><?php echo $row['type_lit']; ?></td>

<td>
<?php
if ($row['statut'] == 'Disponible')
{
    echo '<span class="badge badge-pill badge-success">Disponible</span>';
}
elseif ($row['statut'] == 'Occupe')
{
    echo '<span class="badge badge-pill badge-warning">Occupe</span>';
}
else
{
    echo '<span class="badge badge-pill badge-danger">Endommage</span>';
}
?>
</td>
											...
											<td>
												<div class="text-center dropdown">
                                                    ...
                                                    href="Lit_Modifier.php?id=<?php echo $row['id']; ?>">
                                                    <i class="dw dw-edit2"></i> Modifier
                                                    </a>
                                                    <a class="dropdown-item"
                                                    href="Lit_Supprimer.php?id=<?php echo $row['id']; ?>">
