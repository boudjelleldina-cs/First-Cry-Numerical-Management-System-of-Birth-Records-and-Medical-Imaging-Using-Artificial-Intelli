...
if (isset($_POST["submit"])) {
    ...
    $insert = "INSERT INTO lit(chambre_id, numero_lit, Service, type_lit, statut)
               VALUES('$chambre_id','$numero_lit','$service','$type_lit','$statut')";

    echo $insert . "<br><br>";

    $qry = mysqli_query($link, $insert);
							...
							<div class="col-md-6 mb-3">
								<div style="border:1px solid #ccc;border-radius:10px;padding:16px;background:#f9f9f9;
									...
									<div class="form-group">
										...
										<input type="text" name="chambre_id" class="form-control" placeholder="Entrer la chambre">
										...
										<input type="text" name="numero_lit" class="form-control" placeholder="Entrer le numéro du lit">
									</div>
									...
									<div class="form-group">
										...
										<div class="custom-control custom-radio mb-5">
											 <input type="radio" id="service1" name="service" value="Gynecologie" class="custom-control-input" required>
											<label class="custom-control-label" for="service1">gynecologie</label>
										</div>
										<div class="custom-control custom-radio mb-5">
											<input type="radio" id="service2" name="service" value="Cardiologie" class="custom-control-input">
											<label class="custom-control-label" for="service2">cardiologie</label>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6" style="padding-right:5px;">
											<div class="form-group">
												...
												<input type="text" name="type_lit" class="form-control">
											</div>
										</div>
										...
										<div class="custom-control custom-radio mb-5">
											 <input type="radio" id="statut1" name="statut" value="Disponible" class="custom-control-input" required>
											<label class="custom-control-label" for="statut1">Disponible</label>
										</div>
										<div class="custom-control custom-radio mb-5">
											<input type="radio" id="statut2" name="statut" value="Occupe" class="custom-control-input">
											<label class="custom-control-label" for="statut2">Occupe</label>
										</div>
                                        <div class="custom-control custom-radio mb-5">
											<input type="radio" id="statut3" name="statut" value="Endommage" class="custom-control-input">
											<label class="custom-control-label" for="statut3">Endommage</label>
										</div>
									</div>
									</div>
								</div>
