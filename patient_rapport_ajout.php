...
if(isset($_POST['save_report']))
{
	...
	$htmlBrut = $_POST['rapport'];
	$htmlSecurise = mysqli_real_escape_string($link, $htmlBrut);
	$sql = "INSERT INTO rapport (`id_patient`, `id_medecin`, `rapport`) VALUES ('$id_patient' ,'$id_medecin','$htmlSecurise')";
    
    // 4. Exécution de la requête
    if (mysqli_query($link, $sql)) {
        echo "Le contenu HTML a été sauvegardé avec succès !";
    } else {
        echo "Erreur lors de la sauvegarde : " . mysqli_error($link);
    }
...
">
                    ...
                    ">
                        ...
                        ">
                            ...
                            ">
                                ...
                                <i class="fa fa-pencil-square-o" style="color:white; font-size:18px;"></i>
                    ...
                    ">
                        ...
                        <form method="post">
                        <!-- FORM -->
                      <input type="text" name="id_patient" value="<?php echo $patient['id_patient']; ?>" readonly>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="html-editor pd-20 card-box mb-30">
					<h4 class="h4 text-blue">Rediger votre rapport</h4>
					
					<textarea class="textarea_editor form-control border-radius-0" name ="rapport" id="rapport" placeholder="Enter text ..."></textarea>
				</div>
			</div>
