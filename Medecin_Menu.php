							...
							<li class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									...
									<div class="view-contact">
										<a href="Patient_Table_Medecin.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/Admission1.svg" alt="">
											</span>
										</div>
										<div class="contact-name">
											<h4><span class="badge badge-pill badge-primary">Admission</span></h4>
									...
									<div class="view-contact">
										<a href="Admission_Table_Medecin.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/Accou1.png" alt="">
											</span>
										</div>
										<div class="contact-name">
											<h4><span class="badge badge-pill badge-primary">Accouchement</span></h4>
									...
									<div class="view-contact">
										<a href="Accouchement_Medecin.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/nee2.webp" alt="">
											</span>
										</div>
										<div class="contact-name">
											<h4><span class="badge badge-pill badge-primary">Nouveau Née</span></h4>
									...
									<div class="view-contact">
										<a href="Nee_Table_Medecin.php">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/IRM2.jpg" alt="">
											</span>
										</div>
										<div class="contact-name">
											<h4><span class="badge badge-pill badge-primary">IRM avec IA</span></h4>
									...
									<div class="view-contact">
										<a href="https://huggingface.co/spaces/MRRbrown/first-cry-breast-cancer-classifier">Détails</a>
									</div>
								</div>
							</li>
							<li class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
								<div class="contact-directory-box">
									<div class="contact-dire-info text-center">
										<div class="contact-avatar">
											<span>
												<img src="vendors/images/autre1.png" alt="">
											</span>
										</div>
										<div class="contact-name">
											<h4><span class="badge badge-pill badge-primary">Autre</span></h4>
