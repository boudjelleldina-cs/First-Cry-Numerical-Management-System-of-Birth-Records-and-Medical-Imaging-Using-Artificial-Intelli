            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="stat-card2 p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM medecin WHERE status='Actif'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
                ...
                <div class="col-md-3">
                    <div class="stat-card3 p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM medecin WHERE status='Congé'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
                ...
                <div class="col-md-3">
                    <div class="stat-card3 p-2">
                        ...
                        <h3 class="mb-3"><?php
										$res = mysqli_query($link, "SELECT COUNT(*) AS total FROM medecin WHERE status='Inactif'");
										$tot = mysqli_fetch_assoc($res);
										echo $tot['total'];										
										?>				
						</h3>
       ...
       <div style="
		...
		>
           ...
           <div class="p-12 md:p-8" style="padding:0;">
				<div style="background:#3b7c96;color:white;padding:12px 15px;font-weight:700;font-size:1.2rem;
				...
				Liste des medecins
									...
									<a href="medecin_ajout.php" style="background:white;color:#0f4c81;font-weight:700;
										padding:5px 14px;border-radius:6px;text-decoration:none;font-size:0.9rem;">
										<i class="fa fa-plus"></i> Medecin
									</a>
        ...
        <?php
        $res = mysqli_query($link, "SELECT * FROM medecin");

        while ($row = mysqli_fetch_assoc($res)) {
        ?>

        <tr>
            <td><?php echo $row['id_med']; ?></td>
            <td><?php echo $row['nom_med']; ?></td>
            <td><?php echo $row['prenom_med']; ?></td>
            <td><?php echo $row['date_nais_med']; ?></td>
			<td><?php echo $row['service_med']; ?></td>
			<td class="text-center">
			<?php
												if ($row['status'] == 'Actif') {
													echo '<div><span class="badge badge-pill badge-success">'.$row['status'].'</span></div>';
												} elseif ($row['statut'] == 'Congé') {
													echo '<div><span class="badge badge-pill badge-warning">'.$row['status'].'</span></div>';
												} else {
													echo '<div><span class="badge badge-pill badge-danger">'.$row['status'].'</span></div>';
												}
												?>
			</td>
        ...
        <!--    <td class="text-center">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item"
                               href="view.php?id=<?php //echo $row['id_med']; ?>">
                               👁 Voir
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                            href="#"
                            onclick="navigate('uppatient.php?id=<?php //echo $row['id_med']; ?>&form=1')">
                            ✏️ Modifier Formulaire 1
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item"
                         href="#"
                         onclick="navigate('uppatient2.php?id=<?php //echo $row['id_med']; ?>&form=2')">
                         ✏️ Modifier Formulaire 2
                        </a>
                    </li>
                   <li>
                    <a class="dropdown-item"
                    href="pdf_pat.php?id=<?php //echo $row['id_med']; ?>"
                    target="_blank">
                    📄 PDF
                </a>
            </li>
                        ...
                        <li>
                            <a class="dropdown-item text-danger"
                               href="delete.php?id=<?php //echo $row['id_med']; ?>"
			...
			<td>
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
					...
					<a class="dropdown-item" href="pdf_medecin.php?id=<?php echo $row['id_med']; ?>"><i class="fa fa-print"></i> Imprimer</a>
