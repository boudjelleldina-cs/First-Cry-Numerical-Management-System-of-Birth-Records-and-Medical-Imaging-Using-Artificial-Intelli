...
if(isset($_POST['save_analyses']))
{
    $id_patient = intval($_POST['id_patient']);

    if(isset($_POST['analyse']))
    {
        foreach($_POST['analyse'] as $analyse)
        {

            $analyse = mysqli_real_escape_string($link,$analyse);

            $insert = mysqli_query($link,"
                INSERT INTO analyse_patient
                (id_patient, nom_analyse, date_analyse)
                VALUES
                ('$id_patient','$analyse',NOW())
            ");
        ...
        $success = "Analyses enregistrées avec succès";
    }
}
...
$res_saved = mysqli_query($link,"
    SELECT nom_analyse
    FROM analyse_patient
    WHERE id_patient='$id_patient'
");

while($row = mysqli_fetch_assoc($res_saved))
{
    $saved_analyses[] = $row['nom_analyse'];
}
...
">
                    ...
                    ">
                        ...
                        ">
                            ...
                            ">
                                ...
                                <i class="fa fa-flask" style="color:white; font-size:18px;"></i>
                    ...
                    ">
                        ...
                        ">
                            Analyses grossesse / post-partum
                        </div>
                        <form method="post">
                        <!-- FORM -->
                                    ...
                                    <?php foreach($analyses as $analyse) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <input type="checkbox"name="analyse[]"value="<?php echo $analyse; ?>"<?php
                                                if(in_array($analyse,$saved_analyses))
                                                     {
                                                        echo "checked";
                                                     }
                                                     ?>
