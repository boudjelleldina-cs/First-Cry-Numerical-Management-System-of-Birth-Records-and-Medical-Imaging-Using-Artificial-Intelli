...
">
    ...
    ">
        ...
        <h2 style="
            ...
            color:#0f172a;
        ">
            Gestion dossier nouveaux né(e)s
        </h2>
       ...
       <div style="
        ...
        <thead>
            <tr>
				...
				<th><div class="custom-label-box">Père</div></th>
				<th><div class="custom-label-box">Mère</div></th>
				<th><div class="custom-label-box">Sexe</div></th>
        ...
        <?php
        $res = mysqli_query($link, "SELECT * FROM nee");
        ...
        <tr>
			...
			<td><?php echo $row['date'].' '. $row['temps'] ; ?></td>
			<td><?php echo $row['papa']; ?></td>
			<td><?php echo $row['nomprenommere']; ?></td>
			<td><?php echo $row['sexe']; ?></td>
			<td>
			<?php 
			if ($row['etat']=="Mort-né")
			{
			echo "<span class=\"badge badge-danger\">". $row['etat']."</span>"; 
			}
			else {
			echo "<span class=\"badge badge-success\">". $row['etat']." </span>"; 
			}
			?>
			</td>
			<td>
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list" style="background-color: #D0F2C7;">
					
					<a class="dropdown-item" href="PDF_Nee.php?id=<?php echo $row['id']; ?>" target="_blank"><i class="fa fa-print"></i> Pdf Nee</a>
					<a class="dropdown-item" href="PDF_Nee_Bracelet.php?id=<?php echo $row['id']; ?>"><i class="fa fa-print"></i> Pdf Bracelet</a>
					<a class="dropdown-item" href="PDF_Extrait_Naiss.php?id=<?php echo $row['id']; ?>"><i class="fa fa-print"></i> Extrait de naissance</a>
					<a class="dropdown-item" href="#"><i class="fas fa-baby"></i> Détails</a>
